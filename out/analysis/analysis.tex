...
\begin{table}[H]
\caption{Additional p-value corrections, land conflict conditional and unconditional combined}
\begin{center}
\begin{adjustbox}{max width = \textwidth}
\input{../tables/land_conflict_paper_b_adjust_year}
\end{adjustbox}
\end{center}
\end{table}

\begin{table}[H]
\caption{Additional p-value corrections, general conflict conditional and unconditional combined}
\begin{center}
\begin{adjustbox}{max width = \textwidth}
\input{../tables/all_conflict_paper_b_adjust_year}
\end{adjustbox}
\end{center}
\end{table}

\begin{table}[H]
\caption{Additional p-value corrections, land conflict with grouping by whole column}
\begin{center}
\begin{adjustbox}{max width = \textwidth}
\input{../tables/land_conflict_paper_col_year}
\end{adjustbox}
\end{center}
\end{table}

\begin{table}[H]
\caption{Additional p-value corrections, general conflict with grouping by whole column}
\begin{center}
\begin{adjustbox}{max width = \textwidth}
\input{../tables/all_conflict_paper_col_year}
\end{adjustbox}
\end{center}
\end{table}
