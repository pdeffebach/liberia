...
\noalign{\smallskip}\hline \noalign{\smallskip}\textbf{Panel A: Ouctomes for all residents} &  &  &  &  &  &  &  &  &  &  &  &  &  & \\
 &  &  &  &  &  &  &  &  &  &  &  &  &  & \\
Any serious dispute & 0.299 & 5,435 & 0.022 & 7.2 & 0.220 & 1.000\textsuperscript{a} & 0.525 & 0.306 & 4,011 & 0.012 & 4.1 & 0.456 & 1.000\textsuperscript{b} & 0.912\\
 &  &  & [0.018] &  &  &  &  &  &  & [0.017] &  &  &  & \\
Any unresolved dispute & 0.118 & 5,435 & -0.013 & -11.0 & 0.250 & 1.000\textsuperscript{a} & 0.525 & 0.064 & 4,011 & -0.004 & -6.6 & 0.623 & 1.000\textsuperscript{b} & 0.912\\
 &  &  & [0.011] &  &  &  &  &  &  & [0.009] &  &  &  & \\
...
\quad Resolved via informal mechanism & 0.247 & 1,671 & 0.018 & 7.4 & 0.470 & 1.000\textsuperscript{a} & 0.525 & 0.409 & 1,227 & -0.019 & -4.6 & 0.487 & 1.000\textsuperscript{b} & 0.912\\
 &  &  & [0.025] &  &  &  &  &  &  & [0.027] &  &  &  & \\
\phantom{} Any threats, property damage, or violence \phantom{} &  &  &  &  &  &  &  & 0.331 & 1,227 & -0.069 & -20.7 & 0.009 & 0.500\textsuperscript{b} & 0.053\\
 &  &  &  &  &  &  &  &  &  & [0.026]*** &  &  &  & \\
