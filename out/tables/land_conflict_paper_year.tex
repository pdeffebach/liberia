...
\noalign{\smallskip}\hline \noalign{\smallskip}\textbf{Panel A: Ouctomes for all residents} &  &  &  &  &  &  &  &  &  &  &  &  &  & \\
 &  &  &  &  &  &  &  &  &  &  &  &  &  & \\
Any serious land dispute & 0.221 & 5,435 & 0.003 & 1.2 & 0.867 & 0.860\textsuperscript{a} & 0.867 & 0.087 & 4,011 & 0.008 & 8.8 & 0.473 & 0.690\textsuperscript{b} & 0.722\\
 &  &  & [0.016] &  &  &  &  &  &  & [0.011] &  &  &  & \\
Any unresolved land dispute & 0.070 & 5,435 & -0.020 & -28.0 & 0.015 & 0.100\textsuperscript{a} & 0.043 & 0.024 & 4,011 & 0.002 & 6.4 & 0.744 & 0.690\textsuperscript{b} & 0.744\\
 &  &  & [0.008]** &  &  &  &  &  &  & [0.005] &  &  &  & \\
Any threats, property damage, or violence & 0.122 & 5,435 & -0.010 & -8.1 & 0.397 & 0.630\textsuperscript{a} & 0.636 & 0.041 & 4,011 & -0.012 & -29.3 & 0.039 & 0.090\textsuperscript{b} & 0.113\\
 &  &  & [0.012] &  &  &  &  &  &  & [0.006]** &  &  &  & \\
...
\textbf{Panel B: Conditional on a land dispute} &  &  &  &  &  &  &  &  &  &  &  &  &  & \\
 &  &  &  &  &  &  &  &  &  &  &  &  &  & \\
Length of maximum land conflict &  &  &  &  &  &  &  & 13.247 & 353 & 3.642 & 27.5 & 0.209 & 0.460\textsuperscript{d} & 0.374\\
 &  &  &  &  &  &  &  &  &  & [2.889] &  &  &  & \\
Resolved land dispute & 0.684 & 1,212 & 0.072 & 10.5 & 0.009 & 0.070\textsuperscript{c} & 0.018 & 0.668 & 353 & -0.024 & -3.6 & 0.604 & 0.590\textsuperscript{d} & 0.603\\
 &  &  & [0.027]*** &  &  &  &  &  &  & [0.046] &  &  &  & \\
Any threats, property damage, or violence \phantom{} & 0.554 & 1,212 & -0.024 & -4.3 & 0.496 & 0.590\textsuperscript{c} & 0.496 & 0.476 & 353 & -0.192 & -40.4 & 0.000 & 0.000\textsuperscript{d} & 0.000\\
 &  &  & [0.035] &  &  &  &  &  &  & [0.047]*** &  &  &  & \\
